...
from tkinter import*
pencere=tk.Tk()
pencere.geometry("500x550+50+100")
...
def rgb12():
  led.set_rgb(int(red.get()), int(green.get()), int(blue.get()))  
...
speciallabel= tk.Label(pencere, text="Special Color Setting(RGB)", font="100")
speciallabel.pack()

speciallabel1= tk.Label(pencere, text="Red Value")
speciallabel1.pack()
red = Entry(pencere, width=10)
red.pack()
red.get()

speciallabel2= tk.Label(pencere, text="Green Value")
speciallabel2.pack()
green = Entry(pencere, width=10)
green.pack()
green.get()

speciallabel3= tk.Label(pencere, text="Blue Value")
speciallabel3.pack()
blue = Entry(pencere,width=10)
blue.pack()
blue.get()

button_rgb= Button(pencere, text="Set RGB", command=rgb12)
button_rgb.pack()
